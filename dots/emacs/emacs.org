...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'default-frame-alist
               '(font . "JetBrains Mono Nerd Font-10:weight=light:antialias=subpixel"))

  (set-face-attribute 'mode-line nil :font "JetBrains Mono Nerd Font-10:weight=light:antialias=subpixel")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (setq org-format-latex-options (plist-put org-format-latex-options :scale .5))
#+END_SRC
